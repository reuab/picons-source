...
- When submitting `svg` files, make sure to convert `text` to `paths`. Also use an svg cleaner program like [SVG Cleaner](http://sourceforge.net/projects/svgcleaner), to reduce file size.
